...
public interface ErrorCode {
  ...
  public static final String UserMoblieChkFail = "0060";
  public static final String UserMoblieChkFailInfo ="子帐号列表 手机号已被占用";

  public static final String UserMobileChkParentFail = "0061";
  public static final String UserMobileChkParentFailInfo ="主帐号列表 手机号已被占用";

  public static final String InsertShareRecordFail = "0062";
  public static final String InsertShareRecordFailInfo ="朋友圈分享追加次数失败";
  
  public static final String WechatVerifyFail="0063";
  public static final String WechatVerifyFailInfo="微信账号重复使用错误";

  public static final String CUSMobileChkParentFail = "0064";
  public static final String CUSMobileChkParentFailInfo ="用户手机号已被占用";
  public static final String EXCEPTION_ERROR_INFO="网络异常，请稍后重试";

  public static final String HaveNoPermission="0065";
  public static final String HaveNoPermissionInfo="没有查看权限";
