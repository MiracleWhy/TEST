...
public class FastdfsFastddhclient {
	 ...
	 */
	public FastdfsFastddhclient(String fdhtNamespace) throws MyException {
	 ...
	 * @param fdhtNamespace the FastDHT namespace
	 */
	public FastdfsFastddhclient(TrackerServer trackerServer, StorageServer storageServer, ServerGroup serverGroup, String fdhtNamespace) throws MyException
	{
	 ...
	 * @return 0 for success, != 0 for error (error no)
	 */
	public int upload_file(String my_file_id, long file_size, UploadCallback callback, String file_ext_name) throws IOException, MyException {
		final String group_name = "";
	 ...
	 * @return 0 for success, != 0 for error (error no)
	 */
	public int upload_file(String my_file_id, String group_name, long file_size, UploadCallback callback, String file_ext_name) throws IOException, MyException {
		KeyInfo keyInfo = new KeyInfo(this.fdhtNamespace, my_file_id, MY_CLIENT_FILE_ID_KEY_NAME);
		if (!this.check_fdfs_file_id_not_exist(keyInfo)) {
			return this.status;
		}
