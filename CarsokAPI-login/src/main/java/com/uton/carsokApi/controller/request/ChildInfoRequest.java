...
public class ChildInfoRequest {
    ...
    private String childHeadPic;//2.4.6以前使用此字段
    private String childHeadPicURL;//2.4.6以后使用此字段
    ...
    public String getChildHeadPicURL() {return childHeadPicURL;}

    public void setChildHeadPicURL(String childHeadPicURL) {this.childHeadPicURL = childHeadPicURL;}
}
