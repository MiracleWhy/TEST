...
public class UpdateCarRequest {
	...
	/** 2.4.6开始使用图片列表 */
	//@NotNull(message="picListURL is not null")
	...
	public List<String> getPicListURL() {return picListURL;}

	public void setPicListURL(List<String> picListURL) {this.picListURL = picListURL;}
